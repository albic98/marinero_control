...
class Commander(Node):
    ...
    def __init__(self):
        ...
        self.scale_linear_x = self.declare_parameter('scale_linear_x', 10).value        # 10
        self.scale_linear_y = self.declare_parameter('scale_linear_y', 8).value         # 8
        self.scale_linear_turbo = self.declare_parameter('scale_linear_turbo', 20).value
        self.scale_angular_z = self.declare_parameter('scale_angular_z', 10).value
    ...
    def timer_callback(self):
        ...
        ## opposite phase ##
            ...
            elif vel_msg.linear.x != 0.0 and vel_msg.angular.z < 0:
